...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AircraftType.sorted_position'
        db.add_column(u'checkouts_aircrafttype', 'sorted_position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AircraftType.sorted_position'
        db.delete_column(u'checkouts_aircrafttype', 'sorted_position')
    ...
    models = {
        ...
        u'checkouts.aircrafttype': {
            ...
            'sorted_position': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
